...
/*
===============================================================================
 CUBE_SYMMETRY.CPP - SYMMETRY OPERATIONS & COORDINATE INITIALIZATION
===============================================================================

PURPOSE:
    Implements all symmetry operations, coordinate conversions, and lookup table
    initializations for Rubik's Cube states. Used by both phases of the solver.

KEY FUNCTIONS:
    - Static initialization of move tables for corners, edges, permutations
    - Helper functions for population count, permutation encoding
    - CubeSymmetry constructor: converts cubepos to symmetry coordinates
    - permcube constructor: converts cubepos to permutation coordinates
    - init(): Builds all lookup tables for fast move application and symmetry reduction

NOTES:
    - All static tables are initialized at startup for efficient search
    - Used by phase1 and phase2 for pruning and equivalence checking
*/
